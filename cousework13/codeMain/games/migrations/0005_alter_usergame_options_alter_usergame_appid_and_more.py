# Generated by Django 6.0 on 2026-01-01 04:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('games', '0004_alter_usergame_options_alter_usergame_appid_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='usergame',
            name='status',
            field=models.CharField(blank=True, choices=[('playing', 'Граю'), ('completed', 'Пройдено'), ('planned', 'У планах'), ('dropped', 'Відкладено'), ('not_played', 'Не грав')], max_length=20, null=True),
        ),
        migrations.AlterField(
            model_name='usergame',
            name='updated_at',
        ...
        migrations.AddField(
            model_name='usergame',
            name='lists',
            field=models.ManyToManyField(blank=True, related_name='games', to='games.userlist', verbose_name='Списки'),
        ),
    ]
